...
from models.matchingsuperglue import Matching
...
if __name__ == '__main__':
    ...
    '''
    # load training data
    train_set = SparseDataset(opt.train_path, opt.max_keypoints, config)
    ...
    for epoch in range(1, opt.epoch+1):
        ...
        for i in range(numOftrainSet):
            file_name ='/home/cvlab09/projects/seungjun_an/dataset/train2014/'+str(i+1)+'.jpg' 
